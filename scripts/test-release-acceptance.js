...
assert.ok(indexHtml.includes('v23-normative-maintenance-20260812'), 'index.html debe usar el identificador de caché vigente.');
assert.ok(publicIndexHtml.includes('v23-normative-maintenance-20260812'), 'public/index.html debe usar el identificador de caché vigente.');
