...
| **C02-10** | P2 | Ejecutar aceptación final, etiquetar la versión definitiva, publicar y realizar smoke test posterior al despliegue. | `EN CURSO` (Codex) | C02-01 a C02-08 cerrados; C02-09 tratado como bloqueo externo documentado por falta de revisor jurídico independiente. | Checklist final completo, tag/versionado, despliegue verificado y ciclo C02 cerrado. |

## Orden recomendado mientras el titular está ausente

1. C02-10 — aceptación final de versión estable local, dejando C02-09 como bloqueo externo documentado si el titular no designa revisor jurídico independiente.
