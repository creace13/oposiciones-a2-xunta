...
| **C02-04** | P1 | Incorporar pruebas automatizadas en navegadores reales para navegación, práctica, simulacro, persistencia, recuperación y actualización. | `PENDIENTE` | Ninguna. Es el siguiente elemento ejecutable recomendado. | Chromium, Firefox y WebKit aprobados en escritorio y viewport móvil. |
