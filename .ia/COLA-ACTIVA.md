...
| **C02-11** | P0 | Diagnosticar el fallo de inicio de sesión remoto visto en equipos externos y decidir si es cuenta inexistente/no confirmada, contraseña incorrecta, configuración Supabase o UX de error insuficiente. | `EN CURSO` (Codex) | No guardar credenciales ni correos personales en informes. Para prueba real se necesita cuenta de test controlada por el titular o acceso seguro a Supabase. Relacionada con C02-01, C02-02 y C02-03. | Matriz de diagnóstico sin secretos, causa identificada, texto de error claro para usuarios y prueba del flujo elegido. |
...
1. C02-11 — diagnóstico del login remoto reportado por el titular.
2. C02-05 — accesibilidad WCAG 2.2 AA aplicable.
3. C02-06 — runbook de backup y rollback.
4. C02-07 — seguridad y rendimiento.
5. C02-08 — mantenimiento normativo.
6. Resolver C02-01 y C02-02 antes de validar C02-03.
