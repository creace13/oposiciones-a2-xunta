...
Si el contexto fue compactado o procede de otro modelo (Codex/OpenAI, Antigravity/Google, etc.), ignora la memoria incompleta del chat y reconstruye el estado desde `.ia/ESTADO-PROYECTO.md`, `.ia/COLA-ACTIVA.md` y los informes de `.ia/auditorias/`.
