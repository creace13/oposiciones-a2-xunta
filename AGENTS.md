...
- **Puntos de Guardado (Checkpoints)**: Al completar cada hito o corrección relevante, se debe validar el código, actualizar `.ia/ESTADO-PROYECTO.md` y realizar un commit local. Desde el 20 de julio de 2026 el titular autoriza a Codex/OpenAI a hacer `push` a `origin/main` tras checkpoints validados y documentados. Acciones destructivas, secretos, credenciales, reescritura de historial o configuración sensible siguen fuera de esta autorización automática.
